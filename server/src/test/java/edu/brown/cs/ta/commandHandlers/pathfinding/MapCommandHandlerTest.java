...
import edu.brown.cs.ta.database.DatabaseHandler;
...
public class MapCommandHandlerTest {
  ...
  public void testMapCommand_ValidDB() {
    // valid DB
    assertEquals(MapCommandHandler.mapCommand("map data/pathfinding/smallMaps.sqlite3", "repl"),
        "map set to data/pathfinding/smallMaps.sqlite3");
  ...
  public void testMapCommand_UnsupportedFileType_Default() {
    // unsupported DB
    assertEquals(MapCommandHandler.mapCommand("map data/pathfinding/smallMaps-sqlformat.sql", "repl"),
  ...
  public void testMapCommand_InvalidArgs() {
    ...
    assertEquals(MapCommandHandler.mapCommand("map hi data/pathfinding/smallMaps.sqlite3", "repl"),
  ...
  public void testCheckMapArgs_ValidDB() {
    // valid DB
    assertEquals(MapCommandHandler.checkMapArgs(new String[]{"map", "data/pathfinding/smallMaps.sqlite3"}),
        "map set to data/pathfinding/smallMaps.sqlite3");
  ...
  public void testCheckMapArgs_UnsupportedFileType_Default() {
    // unsupported DB
    assertEquals(MapCommandHandler.checkMapArgs(new String[]{"map", "data/pathfinding/smallMaps-sqlformat.sql"}),
        "ERROR: Database must be of the provided extension types");
  }
  ...
  public void testCheckMapArgs_InvalidArgs() {
    ...
    assertThrows(IllegalArgumentException.class, () ->
        MapCommandHandler.checkMapArgs(new String[]{"map", "hi", "data/pathfinding/smallMaps.sqlite3"}));
  ...
  public void testLoadDB_DBPresence() {
    ...
    // valid DB
    assertEquals(MapCommandHandler.loadDB("data/pathfinding/smallMaps.sqlite3"),
      "map set to data/pathfinding/smallMaps.sqlite3");
  ...
  public void testLoadDB_UnsupportedFileType_Default() {
    // unsupported DB
    assertEquals(MapCommandHandler.loadDB("data/pathfinding/smallMaps-sqlformat.sql"),
        "ERROR: Database must be of the provided extension types");
  }
